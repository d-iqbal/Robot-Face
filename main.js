...
strokeTriangle(260, 80, 220, 300, 100);
...
function strokeTriangle(x1, y1, x2, y2, x3, y3) {
    // Draw a outlined triangle with vertices (x1, y1), (x2, y2), (x3, y3)
    ctx.beginPath();
    ctx.moveTo(x1, y1);
    ctx.lineTo(x2, y2);
    ctx.lineTo(x3, y3);
...
function fillCircle(x, y, r) {
    // Draw a filled circle with vertices (x1, y1), (x2, y2), (x3, y3)
    ctx.beginPath();
...
function strokeCircle(x, y, r) {
    // Draw a stroke circle with vertices (x1, y1), (x2, y2), (x3, y3)
    ctx.beginPath();
    ctx.arc(x, y, r, 0, 2 * Math.PI);
    ctx.stroke();
}
...
function line(x1, y1, x2, y2) {
    // Draw a line with vertices (x1, y1), (x2, y2), (x3, y3)
    ctx.beginPath();
    ctx.moveTo(x1, y1);
    ctx.lineTo(x2, y2);
    ctx.stroke();
